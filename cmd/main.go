...
func main() {
	...
	apiv1.Post("/properties", mw.WithAuthentication(propertyHandler.CreateProperty))
	apiv1.Patch("/properties/:propertyId", mw.WithAuthentication(propertyHandler.UpdatePropertyById))
	apiv1.Delete("/properties/:propertyId", mw.WithAuthentication(propertyHandler.DeletePropertyById))
	...
	apiv1.Post("/agreements", mw.WithAuthentication(agreementsHandler.CreateAgreement))
	apiv1.Delete("/agreements/:agreementId", mw.WithAuthentication(agreementsHandler.DeleteAgreement))
	apiv1.Patch("/agreements/:agreementId", mw.WithAuthentication(agreementsHandler.UpdateAgreementStatus))
