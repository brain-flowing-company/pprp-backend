...
func main() {
	...
	apiv1.Post("/property/favorites/:propertyId", propertyHandler.AddFavoriteProperty)
	apiv1.Delete("/property/favorites/:propertyId", propertyHandler.RemoveFavoriteProperty)
